...
class AboutDlg(wx.Dialog):
	...
	def __init__(self, parent):
		super().__init__(parent, title=_("About Satisfactory Savegame Checker"), \
		...
		lang = Lang.Lang.LANG
		res = os.path.join(wx.App.Get().Path, "Resources", lang, "About.res")
		with open(res, "rt", encoding="UTF-8") as file:
			content = file.read()
			#content = str(content).encode("UTF-8")
		view = wx.html.HtmlWindow(self, size=(680,400), style=wx.html.HW_SCROLLBAR_NEVER)
